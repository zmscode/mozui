...
/// Strategy injected into `#[mozui::property_test]` tests to control the seed
...
/// `mozui::property_test` macro and generally should not be used directly.
///
...
/// This is intended for use with the `mozui::test` macro
