...
//!
//! ```no_run
//! # use mozui::{App, AppContext, Application, Entity};
//! # struct Counter {
//! #     count: usize,
//! # }
//! mozui::platform::application().run(|cx: &mut App| {
...
//!
//! ```no_run
//! # use mozui::{App, AppContext, Application, Context, Entity};
//! # struct Counter {
//! #     count: usize,
//! # }
//! mozui::platform::application().run(|cx: &mut App| {
...
//!
//! ```no_run
//!  # use mozui::{App, AppContext, Application, Entity, prelude::*};
//!  # struct Counter {
//!  #     count: usize,
//!  # }
//!  mozui::platform::application().run(|cx: &mut App| {
...
//!
//! ```no_run
//! # use mozui::{App, AppContext, Application, Context, Entity, EventEmitter};
//! # struct Counter {
//! #     count: usize,
//! # }
//! # struct CounterChangeEvent {
