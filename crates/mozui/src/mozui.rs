//! mozui — A GPU-accelerated UI framework for Rust.
#![warn(missing_docs)]
...
extern crate self as mozui;
#[doc(hidden)]
pub static MOZUI_MANIFEST_DIR: &'static str = env!("CARGO_MANIFEST_DIR");
/// Utility types, traits, and functions.
#[macro_use]
pub mod util;
#[macro_use]
mod action;
