...
/// A TestAppContext is provided to tests created with `#[mozui::test]`, it provides
...
impl TestAppContext {
    /// Creates a new `TestAppContext`. Usually you can rely on `#[mozui::test]` to do this for you.
    ...
    /// this will run backspace on the current editor through the command palette.
