//! Elements are the workhorses of mozui. They are responsible for laying out and painting all of
...
//! own APIs and mozui, or other element implementation, uses the APIs in this module to convert
...
//! tree and any callbacks they have registered with mozui are dropped and the process repeats.
//!
//! But some state is too simple and voluminous to store in every view that needs it, e.g.
//! whether a hover has been started or not. For this, mozui provides the [`Element::PrepaintState`], associated type.
//!
//! # Implementing your own elements
//!
//! Elements are intended to be the low level, imperative API to mozui. They are responsible for upholding,
//! or breaking, mozui's features as they deem necessary. As an example, most mozui elements are expected
...
//!
//! However, most of the time, you won't need to implement your own elements. mozui provides a number of
