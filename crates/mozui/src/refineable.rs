pub use mozui_macros::Refineable;
...
pub trait Refineable: Clone {
    /// The companion refinement type generated by the `Refineable` derive macro.
...
/// A trait for checking whether a refinement would have no effect.
pub trait IsEmpty {
