...
pub fn current_platform(headless: bool) -> Rc<dyn crate::Platform> {
    #[cfg(target_os = "macos")]
    {
...
/// Creates a new [`Application`](crate::Application) using the default platform for the current OS.
pub fn application() -> crate::Application {
    crate::Application::with_platform(current_platform(false))
}

/// Creates a new headless [`Application`](crate::Application) (no windows, no GPU).
...
/// Returns a single-threaded web application (WASM only).
#[cfg(target_family = "wasm")]
