...
// Inlined from the deleted `perf` crate — only the types needed by the `#[perf]` macro.
...
/// # Example
/// ```rust
/// use mozui_util_macros::line_endings;
///
...
/// ```
///
/// This also works with `#[mozui::test]`s, though in most cases it shouldn't
...
/// #[mozui::test]
/// fn oneshot_test(_cx: &mut mozui::TestAppContext) {
///     // Test goes here.
/// }
/// ```
